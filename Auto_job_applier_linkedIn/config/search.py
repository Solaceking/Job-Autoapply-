...
# If you'd like to prefer jobs where English is the primary language or
# prioritize listings with English-first descriptions, set `preferred_language`
# and `prefer_english_first`. `preferred_language` can be a language name
# ("English", "Spanish", etc.) or an empty string to not filter by language.
preferred_language = "English"   # e.g. "English" or "" to not filter by language
# When True, the bot will prefer jobs that appear to be English-first (heuristic)
prefer_english_first = True       # True or False
